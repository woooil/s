...
/**
 * The properties of RArcTwoPoints.
 * @prop theta  - The (directional) central angle.
 */
interface RArcTwoPointsProp {
  theta: ThetaTravel
}
 ...
 *
 * @example RArcTwoPoints {
 *   dependencies: [RPoint1, RPoint2];
 *   prop: { theta: Math.PI };
 * }
 * represents a half circle whose endpoints are RPoint1 and RPoint2.
 *
 * @hierarchy RShape <- RArc <- RArcTwoPoints
 */
class RArcTwoPoints extends RArc {
  public static REL_TYPE = 'RArcTwoPoint'
...
export { RArcTwoPointsProp, RArcTwoPoints }