...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    const pointB = a.add(new RS.RPointOnLine([lineAB], { onLine: { type: 'from1', value: 200 } }, { hide: true }))
    ...
    a.cutLine(lineBC, lineAC, false)
    a.cutLine(lineAC, lineBC, false)
    const angleABC = a.add(new RS.RAngleTwoLines([lineAB, lineBC], { reverseL: true }))
