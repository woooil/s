...
export default function App() {
  ...
  React.useEffect(() => {
    ...
    const labelF = action.add(new RS.RLabelOnLength([lengthA], { label: '4 cm', offsite: new RS.CoordPolar(60, new RS.Theta(-2)) }))
    const labelG = action.add(new RS.RLabelOnLength([lengthB], { label: '2 cm', offsite: new RS.CoordPolar(40, new RS.Theta(-0.2)) }))
    const labelH = action.add(new RS.RLabelOnLength([lengthC], { label: '8 cm', offsite: new RS.CoordPolar(40, RS.Theta.py()) }))
